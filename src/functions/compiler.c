...
const struct func_impl_name impl_tbl_compiler[] = {
	...
	{ "first_supported_argument", func_compiler_first_supported_argument, tc_string },
	{ "first_supported_link_argument", func_compiler_first_supported_link_argument, tc_string },
